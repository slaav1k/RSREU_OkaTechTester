Feature: Регистрация пользователя
  ...
  Scenario Outline: Ошибка при регистрации
    ...
    Examples:
      ...
      | Ivanov  | Pass12 | Pass12        | ivanov@mail.ru   | Москва, Ленина 10 | Пользователь с таким никнеймом уже зарегистрирован   |
      | Sergei  | Pass12 | Pass12        | ivanov@mail.ru   | Москва, Ленина 10 | Пользователь с такой почтой уже зарегистрирован      |
